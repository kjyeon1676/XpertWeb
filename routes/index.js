...
exports.gallery = function(req, res) {
    ...
    if (Email == '') {
        ...
        var path = __dirname + "\\..\\public\\images\\uploaded\\gallery\\";
...
exports.upload = function(req, res, next) {
    ...
    form.on('part', function(part) {
        ...
        if (_fileExt == "png" || _fileExt == "jpeg" || _fileExt == "gif" || _fileExt == "jpg") {
            writeStream = fs.createWriteStream(__dirname + '\\..\\public\\images\\uploaded\\gallery\\' + filename);
        } else {
            writeStream = fs.createWriteStream(__dirname + '\\..\\uploaded\\' + filename);
        }
                    ...
                    if (error) {
                        ...
                        if (result[0]) {
                            if (result[0].priority == 3) {
                                res.clearCookie('cookieemail');
                                res.send('<script>alert(\'차단된 사용자 입니다.\'); location.href=\"/\"</script>');
                            } else {
