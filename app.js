...
app.get('/freeboard_network',routes.freeboard_network);
app.get('/freeboard_system',routes.freeboard_system);
app.get('/freeboard_reversing',routes.freeboard_reversing);
